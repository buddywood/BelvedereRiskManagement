...
import { CYBER_PILLAR_ID, CYBER_SUBCATEGORIES } from './types';
...
const digitalHygieneQuestions: Question[] = [
  {
    ...
    required: true,
    pillar: CYBER_PILLAR_ID,
    subCategory: CYBER_SUBCATEGORIES.DIGITAL_HYGIENE,
    weight: 5,
...
const identityProtectionQuestions: Question[] = [
  {
    ...
    required: true,
    pillar: CYBER_PILLAR_ID,
    subCategory: CYBER_SUBCATEGORIES.IDENTITY_PROTECTION,
    weight: 5,
    scoreMap: { 0: 0, 1: 3, 2: 7, 3: 10 },
  },
  {
...
const bankingSecurityQuestions: Question[] = [
  {
    ...
    required: true,
    pillar: CYBER_PILLAR_ID,
    subCategory: CYBER_SUBCATEGORIES.BANKING_SECURITY,
    weight: 4,
...
const paymentRiskQuestions: Question[] = [
  {
    ...
    required: true,
    pillar: CYBER_PILLAR_ID,
    subCategory: CYBER_SUBCATEGORIES.PAYMENT_RISK,
    weight: 4,
...
export const cyberRiskPillar: Pillar = {
  ...
  subCategories: [
    {
      id: CYBER_SUBCATEGORIES.DIGITAL_HYGIENE,
      name: 'Digital Hygiene',
      description: 'Password management, software updates, and device security practices',
      weight: 3,
      questionIds: digitalHygieneQuestions.map(q => q.id),
    },
    {
      id: CYBER_SUBCATEGORIES.IDENTITY_PROTECTION,
      name: 'Identity Protection',
      description: 'Multi-factor authentication, phishing awareness, and privacy controls',
      weight: 3,
      questionIds: identityProtectionQuestions.map(q => q.id),
    },
    {
      id: CYBER_SUBCATEGORIES.BANKING_SECURITY,
      name: 'Banking Security',
      description: 'Financial account security and transaction monitoring practices',
      weight: 4,
      questionIds: bankingSecurityQuestions.map(q => q.id),
    },
    {
      id: CYBER_SUBCATEGORIES.PAYMENT_RISK,
      name: 'Payment Risk',
      description: 'Payment method security and credit monitoring practices',
      weight: 3,
      questionIds: paymentRiskQuestions.map(q => q.id),
    },
  ],
};
